...
<body onload="onLoad();">
    ...
    <div id="side_panel">
        ...
        <p>
            ...
            Nous relirons votre correction avant de la proposer à tout le monde. Nous nous réservons le droit de retirer toute correction non sérieuse, incomplète ou erronée.<br><br>
            Toutes les corrections seront soumises à la license <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/" target="_blank"><img src="https://mirrors.creativecommons.org/presskit/buttons/80x15/svg/by-nc-sa.svg" alt="CC BY-NC-SA 4.0" /></a>
        </p>
    </div>
</body>
